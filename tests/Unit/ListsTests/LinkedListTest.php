...
describe('LinkedList', function () {
    it('should be instance of LinkedList', function () {
        $linkedList = new \Opmvpc\StructuresDonnees\Lists\LinkedList();
        expect($linkedList)->toBeInstanceOf(\Opmvpc\StructuresDonnees\Lists\ListInterface::class);
        expect($linkedList)->toBeInstanceOf(\Opmvpc\StructuresDonnees\Lists\LinkedList::class);
    });
    ...
    it('should push and remove objects', function () {
        $list = new \Opmvpc\StructuresDonnees\Lists\LinkedList();
        $list->push(new \Opmvpc\StructuresDonnees\Lists\LinkedList());
        $list->push(new \Opmvpc\StructuresDonnees\Lists\LinkedList());
        $list->push(new \Opmvpc\StructuresDonnees\Lists\LinkedList());
        expect($list->size())->toBe(3);
        $list->remove(1);
